...
class IncomeDao(context: Context)  {
    ...
    fun insertIntoIncome(incomeDto: IncomeDto): Int {
        try {
            ...
            val phpInsertFile = properties.getProperty("income_add_php_file")
            ...
            val stringRequest = object : StringRequest(
                ...
                override fun getParams(): Map<String, String> {
                    ...
                    params["date"] = incomeDto.date.toString()
                    params["income_category"] = incomeDto.incomeCategoryName
                    params["income_name"] = incomeDto.incomeName
                    params["income"] = incomeDto.income.toString()
                    params["note"] = incomeDto.note
