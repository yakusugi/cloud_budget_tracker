...
class SpendingProductTypeSumDao(context: Context) {
    private val context: Context = context.applicationContext

    fun selectSpendingProductTypeCalc(
        spendingDto: SpendingProductTypeSumDto,
        ...
        try {
            ...
            val phpSelectFile = properties.getProperty("spending_product_type_search_sum_php_file")
